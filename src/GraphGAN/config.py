...
train_filename = "./data/" + dataset +"/" + "trainset.txt"
test_filename = "./data/" + dataset +"/" + "testset.txt"
test_neg_filename = "./data/" + dataset +"/" + "testset_neg.txt"
pretrain_emb_filename_d = "./pre_train/" + dataset +"/" + "pre_train.emb"
pretrain_emb_filename_g = "./pre_train/" + dataset +"/" + "pre_train.emb"
emb_filenames = ["./results/" + dataset +"/" + "_gen_.emb",
                 "./results/" + dataset +"/" + "_dis_.emb"]
result_filename = "./results/" + dataset +"/" + dataset + ".txt"
cache_filename = "./cache/" + dataset +"/" + dataset + ".pkl"
model_log = "./log/"
